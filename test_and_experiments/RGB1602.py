...
class RGB1602:
  ...
  def command(self,cmd):
    RGB1602_I2C.writeto_mem(LCD_ADDRESS, 0x80, chr(cmd))   # type: ignore

  def write(self,data):
    RGB1602_I2C.writeto_mem(LCD_ADDRESS, 0x40, chr(data))  # type: ignore
    
  def setReg(self,reg,data):
    RGB1602_I2C.writeto_mem(RGB_ADDRESS, reg, chr(data))   # type: ignore
