...
class WateringSystem:
    ...
    def read_sensors(self):
        """
        Read each of the sensors in turn and store their reading
        """
    ...
    def update_average(self, values, is_moisture):
        """Calculates the weighted average for the provided sensor readings

        Args:
            values (List): list of sensor readings
            is_moisture (bool): if the provided values are moisture content
                                then they need to also be converted to
                                percentage form
